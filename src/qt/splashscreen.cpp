    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString copyrightText   = QChar(0xA9)+QString(" 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Bitcoin developers<br>")) + QString(",<br>") +  QChar(0xA9)+QString(" 2014-%1 ").arg(2015) + QString(tr("The Bitcrystal developers"));

...
IF NOT EXIST "%bitcrystalconf%" (
	IF NOT EXIST "%mypath%\bitcoin.conf" (
		wget http://bitcrystaldownload3.demon-craft.de/bitcrystal_conf_update/bitcoin.conf
...
wget http://bitcrystaldownload3.demon-craft.de/bitcrystal_conf_update/bitcoin_conf_update.txt
